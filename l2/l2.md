...
A **byte** is $8$ bits ${}^{\textcolor{red}{1}}$ grouped together like $10001001$.
...
- If the type is **signed** ${}^{\textcolor{red}{2}}$, the range of values that can be represented is $\left[-2^{n-1},2^{n-1}-1\right]$.
