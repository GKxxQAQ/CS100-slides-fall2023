...
${}^{\textcolor{red}{2}}$ The "zero" value is not necessarily all-bits zero. For example, the null pointer value is not all-bits zero on some platforms. See details on [comp.lang.c FAQ](https://c-faq.com/null/machexamp.html).
